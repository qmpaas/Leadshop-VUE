 ...
 * @Last Modified time: 2021-06-21 14:40:10
 */
...
import packageInfo from '@/pages/order/components/packageInfo.vue';
...
import freightRule from './components/freightRule.vue';
import exchangeModifyLogistics from './components/exchangeModifyLogistics.vue';
import waybillTutorials from './components/waybill-tutorials.vue';
...
modules.install = function () {
  ...
  Heshop.component('order', 'packageInfo', packageInfo);
  ...
  Heshop.component('order', 'freightRule', freightRule);
  Heshop.component('order', 'exchangeModifyLogistics', exchangeModifyLogistics);
  Heshop.component('order', 'waybillTutorials', waybillTutorials);
};
