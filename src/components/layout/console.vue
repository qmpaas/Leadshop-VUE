    ...
    <el-container>
      <el-header height="64px">
        ...
        <div class="layout-back">
          <ul>
            <li>
              <router-link :to="{ path: '/finish/pages/index' }">
                <i class="le-icon le-icon-arrow-left"></i>返回微页面</router-link
              >
            </li>
            <li>|</li>
            <li>
            ...
            <el-collapse :value="['basics', 'advanced', 'sales', 'other', 'marketing']">
              <el-collapse-item :name="index" v-for="(mounted, index) in panels" :key="index">
                ...
                <ul class="fm-collapse-tool">
                  <li
                    class="widget"
                    v-for="(item, index) in mounted.children"
                    :key="index"
                    :draggable="true"
